...
var file_dewy_proto_goTypes = []interface{}{
...
func file_dewy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dewy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dewy_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dewy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_dewy_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_dewy_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
