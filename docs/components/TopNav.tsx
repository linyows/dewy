    ...
    <nav className={className}>
      ...
      <section>
        ...
        <button className="" type="button" aria-haspopup="menu" aria-expanded="false" data-state="closed">
          <svg className="lang" xmlns="http://www.w3.org/2000/svg" width="640" height="640" viewBox="0 0 640 640" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <p>{langTitle}</p>
          <svg className="toggle" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
